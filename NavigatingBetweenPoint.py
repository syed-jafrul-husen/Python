...
Label(window,text='Navigation Between Points',fg='black',bg='cyan',font=f1).pack(side=TOP)
...
def removeDisLevel():
    L1 = Label(c, text='          ', fg='grey', bg='grey')
    c.create_window(149, 22, window=L1)
    L2 = Label(c, text='          ', fg='grey', bg='grey')
    c.create_window(351, 22, window=L2)
    L3 = Label(c, text='          ', fg='grey', bg='grey')
    c.create_window(555, 22, window=L3)
    L4 = Label(c, text='          ', fg='grey', bg='grey')
    c.create_window(32, 117, window=L4)
    L5 = Label(c, text='          ', fg='grey', bg='grey')
    c.create_window(145, 177, window=L5)
    L6 = Label(c, text='          ', fg='grey', bg='grey')
    c.create_window(350, 177, window=L6)
    L7 = Label(c, text='          ', fg='grey', bg='grey')
    c.create_window(227,110, window=L7)
    L8 = Label(c, text='          ', fg='grey', bg='grey')
    c.create_window(435, 110, window=L8)
    L9 = Label(c, text='          ', fg='grey', bg='grey')
    c.create_window(630, 110, window=L9)
    L10 = Label(c, text='           ', fg='grey', bg='grey')
    c.create_window(32, 265, window=L10)
    L11 = Label(c, text='          ', fg='grey', bg='grey')
    c.create_window(150, 325, window=L11)
    L12 = Label(c, text='          ', fg='grey', bg='grey')
    c.create_window(230, 265, window=L12)
    L13 = Label(c, text='          ', fg='grey', bg='grey')
    c.create_window(352, 327, window=L13)
    L14 = Label(c, text='          ', fg='grey', bg='grey')
    c.create_window(630, 265, window=L14)
    L15 = Label(c, text='          ', fg='grey', bg='grey')
    c.create_window(155, 487, window=L15)
    L16 = Label(c, text='          ', fg='grey', bg='grey')
    c.create_window(370, 487, window=L16)
    L17 = Label(c, text='          ', fg='grey', bg='grey')
    c.create_window(118, 420, window=L17)
    L18 = Label(c, text='          ', fg='grey', bg='grey')
    c.create_window(535, 410, window=L18)
    L19 = Label(c, text='          ', fg='grey', bg='grey')
    c.create_window(517, 260, window=L19)
...
def totalCost(path):
    costG = [
    ['Mojumdar','Amborkhana',3200],
    ['Mojumdar', 'Pirmoholla',2300],
    ['Amborkhana', 'Dorgah Gate',750],
    ['Amborkhana', 'Housing State',320],
    ['Dorgah Gate', 'Chuhatta',400],
    ['Dorgah Gate', 'Rajar Goli',230],
    ['Chuhatta','Rikabi Bazar',643],
    ['Pirmoholla','Housing State',878],
    ['Pirmoholla','Kolapara',283],
    ['Housing State','Rajar Goli',620],
    ['Housing State','Subid Bazar',1220],
    ['Rikabi Bazar','Kajal Shah',523],
    ['Rikabi Bazar', 'Mirer Moydan',325],
    ['Kolapara','Subuid Bazar',940],
    ['Subid Bazar','Mirer Moydan',705], 
    ['Subid Bazar','Pathan Tula',423],
    ['Kajal Shah','Bagh Bari',2600],
    ['Pathan Tula','Modina Market',1180],
    ['Modina Market','Bagh Bari',1470]
    ]
    Tcost = 0
    n = len(path)
    for x in range(n-1):
        ...
        value = path[x+1]
        for y in range(19):
            if(costG[y][0]==key and costG[y][1]==value):
                Tcost = costG[y][2]+Tcost
                break
            elif(costG[y][1]==key and costG[y][0]==value):
                Tcost = costG[y][2]+Tcost
                break
    #BLOCK = c.create_rectangle(810, 355, 1175, 428, width=2, fill='Pale Green',outline='black')
    f2 = Font(family="Ariel",size=15)
    al = Label(c, text=('Distance between '+path[0]+' & '+path[n-1]), fg='blue', bg='grey',font=f2)
    c.create_window(990, 380, window=al)
    al = Label(c, text='is', fg='blue', bg='grey',font=f2)
    c.create_window(975, 405, window=al)
    al = Label(c, text=Tcost/1000, fg='blue', bg='grey',font=f2)
    c.create_window(1025, 405, window=al)
    al = Label(c, text='K.M.', fg='blue', bg='grey',font=f2)
    c.create_window(1080, 405, window=al)
...
BLOCK = c.create_rectangle(850, 50, 1150, 350, width=2, fill='Pale Green')
setOval()
setLine()
...
#                 width = 20, fg='black', bg='sky blue')
c.create_window(1000, 153, window=IDS)
c.create_window(1000, 183, window=Astar)
...
def setColor():
    ...
    setLine()
    removeDisLevel()
    #BLOCK = c.create_rectangle(805, 350, 1180, 430, fill='grey',outline='grey')
    al = Label(c, text='                                                                                                                                                                ', fg='grey', bg='grey',font='bold')
    c.create_window(990, 380, window=al)
    al = Label(c, text='                                                      ', fg='grey', bg='grey',font='bold')
    c.create_window(970, 405, window=al)
    al = Label(c, text='                                     ', fg='grey', bg='grey',font='bold')
    c.create_window(1000, 405, window=al)
    al = Label(c, text='                                                ', fg='grey', bg='grey',font='bold')
    c.create_window(1050, 405, window=al)
    
restartB = tkinter.Button(c, text ="reset",font='bold',bg='sky blue',activebackground='cyan',height=1,width=8,command=setColor)
c.create_window(950, 270, window=restartB)
...
c.create_window(1050, 270, window=pathB)
